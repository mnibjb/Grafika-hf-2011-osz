...
void onInitialization( ) {
    ...
    chicken.setP0(-5,1.6,-20);
    chicken.setRotateDir(Vector::Y());
    chicken.setAngle(30);
    chicken.setSize(0.4);
    ...
    float sunPos[] = { lightPos.getX(),lightPos.getY(),lightPos.getZ(),0 };
...
void onDisplay( ) {
    glClearColor(0.18,0.745,1, 1.0f);		// torlesi szin beallitasa
